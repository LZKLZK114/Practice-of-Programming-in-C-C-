...
public:
    ...
    MyString(const string a){s=a;}
    //默认构造函数
    MyString(){s="";}
    //拷贝构造函数
    MyString(const MyString& a){s=a.s;}
    //重载（）
    string operator()(int a,int b){
        string t=s.substr(a,b);
        return t;
    }
    //
    MyString operator+(MyString a){
        return MyString(s+a.s);
    }
    //
    ...
    //
    MyString& operator+=(const char* a){s=s+a;return *this;}
    //
    bool operator>(MyString a){return s>a.s;}
    bool operator<(MyString a){return s<a.s;}
    bool operator==(MyString a){return s==a.s;}
    //
//
